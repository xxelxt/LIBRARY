...
public class Borrow {
	...
	public Borrow(int BorrowID, Date StartDate, Date DueDate, Date ReturnedDate, Users Borrower, Publication BorrowedPub, String FineStatus, boolean ReturnedStatus) {
